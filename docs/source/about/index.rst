...
You can refer to the detailed list of changes for past and current releases of GenPipes through the :ref:`Release Notes<docs_release_notes>`.
...
To report bugs or file feature requests: use the `GenPipes issue tracker <hhttps://github.com/c3g/GenPipes/issues?status=new&status=open>`_. For details, see the :ref:`GenPipes Support Page<docs_how_to_get_support>`.
...
To contribute code or documentation changes: submit a pull request on `GenPipes GitHub repository <https://github.com/c3g/GenPipes/pulls>`_.

For citations, publications, workshops,test data sets and other resources, visit `Resources <https://genpipes.readthedocs.io/en/latest/index.html>`_ page.
G