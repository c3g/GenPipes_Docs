...
* Added the "genpipes_file" parameter (optional) to allow users to specify the output file directly from the genpipes command line.
  ...
  .. code-block::
        ...
        user@machine:~$ chipseq.py -c $MUGQIC_PIPELINES_HOME/pipelines/chipseq/chipseq.base.ini $MUGQIC_PIPELINES_HOME/pipelines/chipseq/chipseq.beluga.ini -r readset.chipseq.txt -d design.chipseq.txt -j slurm -t chipseq > chip_cmd.sh
  ...
  .. code-block::
        ...
        user@machine:~$ chipseq.py -c $MUGQIC_PIPELINES_HOME/pipelines/chipseq/chipseq.base.ini $MUGQIC_PIPELINES_HOME/pipelines/chipseq/chipseq.beluga.ini -r readset.chipseq.txt -d design.chipseq.txt -j slurm -t chipseq --genpipes-file chip_cmd.sh
