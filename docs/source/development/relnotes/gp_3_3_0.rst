...
* Two new steps were added in the :ref:`HiC Sequencing Pipeline<docs_gp_hicseq>`:
  ...
  - *Quality Scores*: `QuASAR <http://hifive.docs.taylorlab.org/en/latest/quasar_scoring.html>`_ (part of `hifive <http://hifive.docs.taylorlab.org/en/latest/introduction.html>`_ suite), is used to calculate quality score per chromosome.
