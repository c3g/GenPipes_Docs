...
* **Objective:** *Choose GenPipes deployment*
   ...
   Should I deploy GenPipes on my resources or use a pre-installed copy of the same deployed on Compute Canada servers? **Refer** to :ref:`Choose GenPipes deployment option<docs_choose_gp_dep>` section in Quick Start Guide Table of Contents above.
