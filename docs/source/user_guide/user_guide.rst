...
GenPipes is an open source, next generation sequencing framework written in Python. Developed at the `Canadian Centre for Computational Genomics (C3G) <https://www.computationalgenomics.ca/>`_, GenPipes facilitates writing and execution of multi-step genomics processing pipelines on HPC clusters. It offers 12 validated pipelines that include CoV, Tumor Pair, RNA, ChIP, DNA, Methylation and Hi-C sequencing.
