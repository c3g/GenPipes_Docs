...
The latest release of GenPipes is |genpipes_version|. You can refer to the :ref:`latest GenPipes Release note<docs_gp_relnote_4_4_1>` for details regarding what has changed.  See :ref:`Release Notes<docs_release_notes>` section of this documentation for details regarding prior GenPipes releases.
