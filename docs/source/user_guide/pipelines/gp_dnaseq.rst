...
.. tab-set:: 
      ...
      .. tab-item:: About
         ...
         .. card::
            ...
            See :ref:`dnaschema` tab for the pipeline workflow.
      ...
      .. tab-item:: Schema
         ...
         .. dropdown:: Mpileup
            ...
            `Click for a high resolution image of Mpileup DNA Sequencing Pipeline <https://bitbucket.org/mugqic/genpipes/src/master/resources/workflows/mmd/png/dnaseq.mpileup.mmd.png>`_.
         ...
         .. dropdown:: Light
            ...
            `Click for a high resolution image of Light DNA Sequencing Pipeline <https://bitbucket.org/mugqic/genpipes/src/master/resources/workflows/mmd/png/dnaseq.light.mmd.png>`_.
         ...
         .. dropdown:: SV
            ...
            `Click for a high resolution image of SV DNA Sequencing Pipeline <https://bitbucket.org/mugqic/genpipes/src/master/resources/workflows/mmd/png/dnaseq.sv.mmd.png>`_.
