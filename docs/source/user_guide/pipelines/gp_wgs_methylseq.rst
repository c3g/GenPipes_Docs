...
.. tab-set:: 
      ...
      .. tab-item:: Usage
         ...
         .. dropdown:: Command
            ...
            .. code::
               ...
               methylseq.py [options] [--genpipes_file GENPIPES_FILE]
      ...
      .. tab-item:: Steps
         ...
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 2. | |trimmomatic|                   | |trimmomatic|                    | |trimmomatic|                     |      
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 3. | |merge_trimmomatic_stats|       | |merge_trimmomatic_stats|        | |merge_trimmomatic_stats|         | 
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 4. | |bismark_align|                 | |dragen_align|                   | |dragen_align|                    |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 5. | |add_bam_umi|                   | |add_bam_umi|                    | |add_bam_umi|                     |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 6. | |sambamba_merge_sam_files|      | |sambamba_merge_sam_files|       | |sambamba_merge_sam_files|        |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 7. | |picard_remove_duplicates|      | |picard_remove_duplicates|       | |sort_dragen_sam|                 |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 8. | |metrics|                       | |metrics|                        | |metrics|                         |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 9. | |methylation_call|              | |methylation_call|               | |dragen_methylation_call|         |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 10.| |wiggle_tracks|                 | |wiggle_tracks|                  | |split_dragen_methylation_report| |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 11.| |methylation_profile|           | |methylation_profile|            | |methylation_profile|             |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 12.| |ihec_sample_metrics_report|    | |ihec_sample_metrics_report|     | |dragen_bedgraph|                 |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 13.| |bis_snp|                       | |bis_snp|                        | |wiggle_tracks|                   |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 14.| |filter_snp_cpg|                | |filter_snp_cpg|                 | |ihec_sample_metrics_report|      |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 15.| |prepare_methylkit|             | |prepare_methylkit|              | |bis_snp|                         |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 16.| |methylkit_diff_analysis|       | |methylkit_diff_analysis|        | |filter_snp_cpg|                  |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 17.| |multi_QC|                      | |multi_QC|                       | |prepare_methylkit|               |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 18.| |cram_output|                   | |cram_output|                    | |methylkit_diff_analysis|         |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 19.|                                 |                                  | |multi_QC|                        |
         +----+---------------------------------+----------------------------------+-----------------------------------+
         | 20.|                                 |                                  | |cram_output|                     |
