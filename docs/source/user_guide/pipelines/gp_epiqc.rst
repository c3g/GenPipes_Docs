...
For the latest implementation and usage details refer to epiQC Pipeline implementation `README file <https://bitbucket.org/mugqic/genpipes/src/epiqc/pipelines/epiqc/README.md>`_.
